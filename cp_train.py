...
if __name__ == '__main__':
    ...
    train_dataset_args = DatasetArguments(task_type=TASK, dataset_type='train')
    train_dataset = KFashionDataset(args.data_dir, train_dataset_args, input_processor)
    train_dataloader = DataLoader(
        dataset=train_dataset, batch_size=args.train_batch_size, shuffle=True, num_workers=args.num_workers)
    
    val_dataset_args = DatasetArguments(task_type=TASK, dataset_type='valid')
